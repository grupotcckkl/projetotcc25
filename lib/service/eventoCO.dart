...
//         height: 200,
//         width: 250,
//         child: Center(child: Text('Evento Númeoro 1')),
      ...
      _carrosselItens.add(
        InkWell(
          ...
          child: Container(
            ...
            width: 250,
            child: Center(
                child: Text('Evento Númeoro $_contaitens',
          ...
          children: [
            ...
            Column(
              children: [
                Container(
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Meus Eventos      bem vindo, Kayke', // puxa aqui o nome que ta na conta
                ...
                //CARROSSEL TIRAR O SCROLL INFINITO E FAZER COM QUE NOTÃO MAIS ADICIONA CONTAINER
                CarouselSlider(
