import 'package:connectus/service/telas-CO/relatorioCO.dart';
...
class InfoCO extends StatefulWidget {
  @override
  State<InfoCO> createState() => _InfoCOState();
}

class _InfoCOState extends State<InfoCO> {
  String ticket = "";
  ...
  readQrcode() async {
    ...
    //setState(() => ticket = code != '-1' ? code: "QR Code não cadastrado"  );
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Treinamento em SCS dia 18 de Abril.', style: TextStyle(fontSize: 20),),
                                ),
                                height: 100,
                                width: 250,
                              ),
                              ...
                              children: [
                                ElevatedButton.icon(
                                  style: ElevatedButton.styleFrom(
                                      backgroundColor: Color(0xFF777EA9)
                                  ),
                                  label: Text('Scannear',
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed:(){
                          Navigator.push(
                            context,
                            PageTransition(
                              child: RelatorioCO(leituras: leituras,),
                              type: PageTransitionType.fade,
                              duration: Duration(milliseconds: 550),
                            ),
                          );
